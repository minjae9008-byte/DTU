...
| VVC QP 22 (기본) | 5.8 Mbps | 98.77 | 484초 |
| VVC QP 25 | 3.4 Mbps | 97.23 | 349초 |
| VVC QP 30 | 1.7 Mbps | 91.21 | 256초 |

같은 VMAF로 맞춰 비교하면 AV1 파일은 H.264보다 약 35%, HEVC보다 약 9% 작습니다. 인코딩도 HEVC보다 빨라서 기본 코덱은 AV1입니다. VVC는 AV1보다도 35~40% 작지만(VMAF 97.2: VVC 3.4 Mbps, AV1 5.9 Mbps) 인코딩이 15~20배 느리고, 재생할 수 있는 기기가 아직 적습니다.
...
| VVC/H.266 (VVenC) | 차세대 표준, 같은 화질에서 AV1보다 35~40% 작은 파일 | 재생 가능한 플레이어가 적고(최신 FFmpeg/mpv/VLC 4) 인코딩이 AV1보다 15~20배 느림 — 실험용 |
| NVENC / Quick Sync / AMF / VideoToolbox | 매우 빠름 | 같은 용량에서 소프트웨어 인코더보다 화질이 낮음. 설치된 GPU에서 실제로 동작하는지 시험 인코딩해서 목록에 표시 |

- **품질(CRF/QP)**: 낮출수록 고화질이고 파일이 커집니다. 기본값(AV1 27 / HEVC 20 / H.264 18 / VVC 22)은 무손실 업스케일 결과 대비 VMAF 98.5~98.9로, 눈으로는 차이가 거의 없는 수준입니다.
